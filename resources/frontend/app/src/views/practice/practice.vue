            ...
            <section class="answer-form-controller">
                <article class="main-switch-components">
                    <div class="controller-position-elements task-section">
                        <practice_check :title="this.data_course.list[this.data_slide].tasks[this.data_task].title" 
                        :text="this.data_course.list[this.data_slide].tasks[this.data_task].text" v-if="checkTemplate()==1" ref="form-page"/>
                        <practice_code :title="this.data_course.list[this.data_slide].tasks[this.data_task].title" 
                        :text="this.data_course.list[this.data_slide].tasks[this.data_task].text" v-else-if="checkTemplate()==2"  ref="form-page"/>
                        <practice_comparison :title="this.data_course.list[this.data_slide].tasks[this.data_task].title" 
                        :text="this.data_course.list[this.data_slide].tasks[this.data_task].text"  v-else-if="checkTemplate()==3"  ref="form-page"/>
                        <practice_select :title="this.data_course.list[this.data_slide].tasks[this.data_task].title" 
                        :text="this.data_course.list[this.data_slide].tasks[this.data_task].text"  v-else-if="checkTemplate()==4"  ref="form-page"/>
                        <practice_video :title="this.data_course.list[this.data_slide].tasks[this.data_task].title" 
                        :text="this.data_course.list[this.data_slide].tasks[this.data_task].text" v-else-if="checkTemplate()==5"  ref="form-page"/>
                        <practice_question :title="this.data_course.list[this.data_slide].tasks[this.data_task].title" 
                        :text="this.data_course.list[this.data_slide].tasks[this.data_task].text" v-else  ref="form-page"/>
                    </div>
                </article>
            </section>
        </section>
                        ...
                        tasks:[
                            {
                                ...
                                text:'This is the first part. You can solve the second part here when you are done with this. Multiply two numbers! Simple!The arguments are passed as strings.The numbers may be way very largeAnswer should be returned as a stringThe returned "number" should not start with zeros e.g. 0123 is invalidNote: 100 randomly generated tests!',
                                isComplete:true
                            },
                            {
                                type:4,
